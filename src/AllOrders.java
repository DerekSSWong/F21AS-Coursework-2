...
public class AllOrders {
	...
	/**
	 * 
	 * Adds order to treemap with key i
	 * increments i to ensure key is unique
	 *
	 */
	 ...
	 * used to overwrite arrayList when searching for Orders with a customerID
	 * 
	 */
	...
	/**
	 * Loops through ao treemap and checks if each value contains customerID
	 * adds Order to an arrayList if Order contains customerID
	 * 
	 * @param cusID
